...
ola-data-analytics/
│
├── Mumbai_Bookings_July2025.csv       # Cleaned dataset (CSV format)
├── Mumbai_Bookings_July2025.xlsx      # Cleaned dataset (Excel format)
├── Ola_Data.sql                       # All SQL queries and views
...
3. **Run SQL queries** — Execute `Ola_Data.sql` in MySQL Workbench to create views and explore results.

4. **Open Power BI dashboard** — Open `Ola_Dashboard.pbix` in Power BI Desktop and connect it to your local MySQL database or import `Mumbai_Bookings_July2025.xlsx` directly.
